...
namespace SignalF.Measurement.Viewer.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<SignalF.Measurement.Viewer.Models.ApplicationUser> users;
        protected RadzenDataGrid<SignalF.Measurement.Viewer.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(SignalF.Measurement.Viewer.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(SignalF.Measurement.Viewer.Models.ApplicationUser user)
        {
            try
            {
