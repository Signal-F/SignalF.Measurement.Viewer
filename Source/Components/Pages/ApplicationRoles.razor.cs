...
namespace SignalF.Measurement.Viewer.Components.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<SignalF.Measurement.Viewer.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(SignalF.Measurement.Viewer.Models.ApplicationRole role)
        {
            try
            {
